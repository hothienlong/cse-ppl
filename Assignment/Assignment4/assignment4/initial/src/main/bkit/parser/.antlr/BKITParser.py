# Generated from c:\Users\ADMIN\Desktop\assignment4\assignment4\initial\src\main\bkit\parser\BKIT.g4 by ANTLR 4.8
# encoding: utf-8
from antlr4 import *
...
class BKITParser ( Parser ):
    ...
    class VariableContext(ParserRuleContext):
        ...
        def non_initial(self):
            return self.getTypedRuleContext(BKITParser.Non_initialContext,0)


        def initial(self):
            return self.getTypedRuleContext(BKITParser.InitialContext,0)
    ...
    class Non_initialContext(ParserRuleContext):
        ...
        def var_primitive(self):
            return self.getTypedRuleContext(BKITParser.Var_primitiveContext,0)
        ...
        def getRuleIndex(self):
            return BKITParser.RULE_non_initial
    ...
    def non_initial(self):
        ...
        localctx = BKITParser.Non_initialContext(self, self._ctx, self.state)
    ...
    class Var_primitiveContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return BKITParser.RULE_var_primitive
    ...
    def var_primitive(self):
        ...
        localctx = BKITParser.Var_primitiveContext(self, self._ctx, self.state)
    ...
    class Var_arrayContext(ParserRuleContext):
        ...
        def LRB(self, i:int=None):
            if i is None:
                return self.getTokens(BKITParser.LRB)
            else:
                return self.getToken(BKITParser.LRB, i)
    ...
    class InitialContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return BKITParser.RULE_initial
    ...
    def initial(self):
        ...
        localctx = BKITParser.InitialContext(self, self._ctx, self.state)
    ...
    def array_literal(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << BKITParser.TRUE) | (1 << BKITParser.FALSE) | (1 << BKITParser.LB) | (1 << BKITParser.INTEGER_LITERAL) | (1 << BKITParser.FLOAT_LITERAL) | (1 << BKITParser.STRING_LITERAL))) != 0):
                self.state = 133
                self.literal()
                self.state = 138
                self._errHandler.sync(self)
    ...
    class Func_decContext(ParserRuleContext):
        ...
        def list_stmt(self):
            return self.getTypedRuleContext(BKITParser.List_stmtContext,0)
    ...
    class List_vardecContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return BKITParser.RULE_list_vardec
    ...
    def list_vardec(self):
        ...
        localctx = BKITParser.List_vardecContext(self, self._ctx, self.state)
    ...
    class List_stmtContext(ParserRuleContext):
        ...
        def list_vardec(self):
            return self.getTypedRuleContext(BKITParser.List_vardecContext,0)
        ...
        def getRuleIndex(self):
            return BKITParser.RULE_list_stmt
    ...
    def list_stmt(self):
        ...
        localctx = BKITParser.List_stmtContext(self, self._ctx, self.state)
    ...
    class If_stmtContext(ParserRuleContext):
        ...
        def list_stmt(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(BKITParser.List_stmtContext)
            else:
                return self.getTypedRuleContext(BKITParser.List_stmtContext,i)
    ...
    def return_stmt(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            if (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << BKITParser.TRUE) | (1 << BKITParser.FALSE) | (1 << BKITParser.SUB_INT) | (1 << BKITParser.SUB_FLOAT) | (1 << BKITParser.NOT) | (1 << BKITParser.LP) | (1 << BKITParser.LB) | (1 << BKITParser.INTEGER_LITERAL) | (1 << BKITParser.FLOAT_LITERAL) | (1 << BKITParser.STRING_LITERAL) | (1 << BKITParser.IDENTIFIER))) != 0):
                self.state = 255
                self.exp()
    ...
    class ExpContext(ParserRuleContext):
        ...
        def relational_exp(self):
            return self.getTypedRuleContext(BKITParser.Relational_expContext,0)
    ...
    class Relational_expContext(ParserRuleContext):
        ...
        def logical_binary_exp(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(BKITParser.Logical_binary_expContext)
            else:
                return self.getTypedRuleContext(BKITParser.Logical_binary_expContext,i)
        ...
        def LESS_THAN_FLOAT(self):
            return self.getToken(BKITParser.LESS_THAN_FLOAT, 0)

        def LESS_EQUAL_FLOAT(self):
            return self.getToken(BKITParser.LESS_EQUAL_FLOAT, 0)

        def GREATER_THAN_FLOAT(self):
            return self.getToken(BKITParser.GREATER_THAN_FLOAT, 0)

        def GREATER_EQUAL_FLOAT(self):
            return self.getToken(BKITParser.GREATER_EQUAL_FLOAT, 0)

        def getRuleIndex(self):
            return BKITParser.RULE_relational_exp
    ...
    def relational_exp(self):
        ...
        localctx = BKITParser.Relational_expContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.logical_binary_exp(0)
                self.state = 267
                self.match(BKITParser.NOT_EQUAL)
                self.state = 268
                self.logical_binary_exp(0)
                pass
                ...
                self.logical_binary_exp(0)
                self.state = 279
                self.match(BKITParser.LESS_EQUAL)
                self.state = 280
                self.logical_binary_exp(0)
                pass
                ...
                self.logical_binary_exp(0)
                self.state = 283
                self.match(BKITParser.GREATER_EQUAL)
                self.state = 284
                self.logical_binary_exp(0)
                pass
                ...
                self.logical_binary_exp(0)
                self.state = 291
                self.match(BKITParser.LESS_THAN_FLOAT)
                self.state = 292
                self.logical_binary_exp(0)
                pass
                ...
                self.logical_binary_exp(0)
                self.state = 295
                self.match(BKITParser.LESS_EQUAL_FLOAT)
                self.state = 296
                self.logical_binary_exp(0)
                pass
                ...
                self.logical_binary_exp(0)
                self.state = 299
                self.match(BKITParser.GREATER_THAN_FLOAT)
                self.state = 300
                self.logical_binary_exp(0)
                pass
                ...
                self.logical_binary_exp(0)
                self.state = 303
                self.match(BKITParser.GREATER_EQUAL_FLOAT)
                self.state = 304
                self.logical_binary_exp(0)
                pass
    ...
    class Logical_binary_expContext(ParserRuleContext):
        ...
        def adding_exp(self):
            return self.getTypedRuleContext(BKITParser.Adding_expContext,0)


        def logical_binary_exp(self):
            return self.getTypedRuleContext(BKITParser.Logical_binary_expContext,0)
        ...
        def getRuleIndex(self):
            return BKITParser.RULE_logical_binary_exp
    ...
    def logical_binary_exp(self, _p:int=0):
        ...
        localctx = BKITParser.Logical_binary_expContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 52
        ...
        try:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = BKITParser.Logical_binary_expContext(self, _parentctx, _parentState)
    ...
    class Adding_expContext(ParserRuleContext):
        ...
        def multiplying_exp(self):
            return self.getTypedRuleContext(BKITParser.Multiplying_expContext,0)
        ...
        def getRuleIndex(self):
            return BKITParser.RULE_adding_exp
    ...
    def adding_exp(self, _p:int=0):
        _parentctx = self._ctx
        _parentState = self.state
        localctx = BKITParser.Adding_expContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 54
        ...
        try:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = BKITParser.Adding_expContext(self, _parentctx, _parentState)
    ...
    class Multiplying_expContext(ParserRuleContext):
        ...
        def logical_unary_exp(self):
            return self.getTypedRuleContext(BKITParser.Logical_unary_expContext,0)
        ...
        def INT_REMAINDER(self):
            return self.getToken(BKITParser.INT_REMAINDER, 0)

        def getRuleIndex(self):
            return BKITParser.RULE_multiplying_exp
    ...
    def multiplying_exp(self, _p:int=0):
        _parentctx = self._ctx
        _parentState = self.state
        localctx = BKITParser.Multiplying_expContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 56
        ...
        try:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = BKITParser.Multiplying_expContext(self, _parentctx, _parentState)
                        ...
                        if not self.precpred(self._ctx, 2):
                            ...
                            raise FailedPredicateException(self, "self.precpred(self._ctx, 2)")
                        self.state = 359
                        self.match(BKITParser.INT_REMAINDER)
                        self.state = 360
                        self.logical_unary_exp()
                        pass
    ...
    class Logical_unary_expContext(ParserRuleContext):
        ...
        def sign_exp(self):
            return self.getTypedRuleContext(BKITParser.Sign_expContext,0)


        def getRuleIndex(self):
            return BKITParser.RULE_logical_unary_exp
    ...
    def logical_unary_exp(self):
        ...
        localctx = BKITParser.Logical_unary_expContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if token in [BKITParser.NOT]:
                ...
                self.logical_unary_exp()
                pass
            elif token in [BKITParser.TRUE, BKITParser.FALSE, BKITParser.SUB_INT, BKITParser.SUB_FLOAT, BKITParser.LP, BKITParser.LB, BKITParser.INTEGER_LITERAL, BKITParser.FLOAT_LITERAL, BKITParser.STRING_LITERAL, BKITParser.IDENTIFIER]:
                self.enterOuterAlt(localctx, 2)
                self.state = 368
                self.sign_exp()
                pass
    ...
    class Sign_expContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return BKITParser.RULE_sign_exp
    ...
    def sign_exp(self):
        ...
        localctx = BKITParser.Sign_expContext(self, self._ctx, self.state)
        self.enterRule(localctx, 60, self.RULE_sign_exp)
        try:
            self.state = 376
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [BKITParser.SUB_INT]:
                self.enterOuterAlt(localctx, 1)
                self.state = 371
                self.match(BKITParser.SUB_INT)
                self.state = 372
                ...
                self.sign_exp()
                pass
            elif token in [BKITParser.TRUE, BKITParser.FALSE, BKITParser.LP, BKITParser.LB, BKITParser.INTEGER_LITERAL, BKITParser.FLOAT_LITERAL, BKITParser.STRING_LITERAL, BKITParser.IDENTIFIER]:
                self.enterOuterAlt(localctx, 3)
                self.state = 375
                self.index_exp()
                pass
