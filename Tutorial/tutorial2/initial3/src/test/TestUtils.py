...
class TestLexer:
    ...
    def checkLexeme(input,expect,num):
        ...
        line = dest.read()
        '''solution đc sinh ra, rồi đem so sánh với 
        expect(dự đoán bằng tay rồi điền vào) để kiểm tra BKIT.g4 chạy đúng ko'''
        return line == expect

    '''tách token -> viết kết quả vào file solution'''
